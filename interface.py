...
def clicked_btn1(): #функции для создания перевода
    ...
    lbl4=Label(window_trans, text="Выберите язык для итогового файла",font=("Montserrat Classic", 12),background = '#ed4f5b', foreground = "#545454")
    file_path=Entry(window_trans, width=30, background='#ffee95')
    file_path.place(x=60,y=70)
...
btn1=Button(window, text='Перевести', command=clicked_btn1, font=("Arial", 12),background = '#545454', foreground = "#ffde59", width=10)
